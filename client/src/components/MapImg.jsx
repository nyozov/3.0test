...
const Index = () => (
  <div classname="overflow-y-hidden bg-gray-100">
    <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
      <h1 className="focus:outline-none text-center text-3xl lg:text-4xl font-extrabold lg:leading-9 tracking-wider custom-text-gradient">How it works?</h1>
        ...
        <div className="hidden md:flex justify-center w-full">
          ...
          <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
            ...
            <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
              <h1 className="focus:outline-none text-xl font-bold text-shadow leading-5">SignUp for an Account</h1>
